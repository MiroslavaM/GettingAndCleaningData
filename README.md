...
<b>Course Project Step5</b> - Using the <i><b>ddplyr</i></b> <i>group_by</i>, <i>summarise_each</i> functions we group the data by "ActivityLablel" and "Subject" and write the summarized dataset in seperate file.
